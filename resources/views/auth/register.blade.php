                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="password-admin" type="password" class="form-control" name="password_admin" required placeholder="Admin password">
                                @if ($errors->has("password_admin"))
                                    
                                    <div class="is-danger" style="color: red; font-weight: bold">
