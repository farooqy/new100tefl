...
@section ("content")
    ...
    <div class="pixfort_gym_13 animate-in slow-mo" id="section_gym_2" data-anim-type="zoom-in-up-large" data-anim-delay="">
        <div class="page_style pix_builder_bg" style="min-height: 500px; background-image: url(&quot;images/uploads/mmexport1548913680813.jpg&quot;); background-color: rgb(31, 51, 74); padding-top: 0px; padding-bottom: 0px; box-shadow: none; border-color: rgb(68, 68, 68); background-size: cover; background-attachment: fixed; background-repeat: no-repeat;" src="images/uploads/mmexport1548913680813.jpg">
            <div class="container">
                <div class="sixteen columns">
                    <div class="text_page" style="margin-top:150px; margin-bottom:30px;">
                        <h1 class="title">
                            <span class="editContent" style="background-color:rgba(0,0,0,0.5); padding:15px; border-radius:10px">
                                About Us
                          </span>
                      </h1>
                      <h3 class="subtitle"><span class="editContent"></span></h3>
                    </div>
                </div>
            </div>
        </div>
...
<section class="container-fluid animate-in slow-mo" id="aboutBlock" data-anim-type="zoom-in-up-large" data-anim-delay="" style="background-color:rgba(0,0,0,0.5); padding:20px; background:linear-gradient(rgba(0,0,0,0), rgba(0,0,0,0)), url('images/uploads/st001.jpg - Copy.jpg')">
        ...
        <div class="container" style="padding:0px; border:thin solid gray; padding:10px; background-color:rgba(0,0,0,0.9); color:white; font-size:15px; margin-bottom:20px">
            ...
            <div class="sixteen columns animate-in slow-mo" data-anim-type="zoom-in-up-large" data-anim-delay="" style="margin:0px;">
                <div style="margin:0px;" class="four columns">
                    <div class="" style="height=100%; width=100%; padding:10%; ">
                        <!--<img src="images/uploads/service1.jpg" class="" width="100%" height="100%">-->
                        <span class="pi creative_c_icon pixicon-ribbon2" style="height: 100%; width: 100%; color: rgb(241, 194, 50); font-size: 200px; background-color: rgba(0, 0, 0, 0);">
        ...
        <div class="container animate-in slow-mo" data-anim-type="zoom-in-up-large" data-anim-delay="" style="padding:0px; border:thin solid gray; padding:10px; background-color:rgba(0,0,0,0.9); color:white; font-size:15px; margin-bottom:20px">
            ...
            <div class="sixteen columns" style="margin:0px;">
                <div class="twelve columns">
                    易佰外师，落地南京市江宁区人才服务中心，源自2013年创立的上海易语外教，旨在成为外籍人才招聘、管理以及培训行业最值得信赖的企业。<br>
                    “易佰”谐音“100”，“外师”一方面是指“外籍老师”或者“外教”， 另一方面，也是指我们将作为“外国人的老师/培训师”， 帮助他们更好的在中国工作和生活
                    。与普通外教中介不同，我们主要为客户提供定制化的外籍教师招聘管理咨询解决方案（招聘管家服务），
                    同时我们也为外国人提供中国的生活、工作以及创业指导咨询服务。积极参与政府主导的外籍人才就业创业扶持项目，
                    架设国际人才沟通交流桥梁。易佰外师目前的主要服务对象为私立教育机构，如培训机构，私立K-12学校，国际学校等，
                    主要服务内容为：<br>
                    1. 外教推荐（中介）<br>2. 签证咨询与办理 <br>
                    3. 招聘管家（托管）<br> 4. 海外校招代理  <br>5. 外籍员工就业培训
                </div>
                <div style="margin:0px;" class="four columns">
                    <div class="" style="height=100%; width=100%; padding:10%; ">
                        <!--<img src="images/uploads/service1.jpg" class="" width="100%" height="100%">-->
        ...
        <div class="container" style="padding:0px; border:thin solid gray; padding:10px;  color:white; font-size:15px; margin-bottom:20px">
            ...
            <div class="sixteen columns animate-in slow-mo" data-anim-type="zoom-in-up-large" data-anim-delay="" style="margin:0px;">
                ...
                <div class="eight columns" style="background-color:rgba(0,0,0,0.9);border:thin solid white; margin:2px">
                    ...
                    <div class="text-center">
                        <div style="margin-bottom:10px; padding-left:10px; text-align:center;">
                            Phone: +86 189 9405 0515
                        </div>
                        <div style="margin-bottom:10px; padding-left:10px; text-align:center;">  
                            Wechat ID:  ybws100tefl
                        </div>
                        <div style="margin-bottom:48px; padding-left:10px; text-align:center;">
                            Email ID: services@100tefl.com
                        </div>
                    </div>
                </div>
