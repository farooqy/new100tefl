    ...
    return function(e) {
        ...
        function n(e) {
            ...
            e.events.on("afterCommand", function(t) {
                ...
                if (n.which === i.KEY_BACKSPACE || n.which === i.KEY_DELETE) {
                    ...
                    var l = e.editorWindow.getSelection(),
                        c = !!l.rangeCount && l.getRangeAt(0);
                    if (!c) return !1;
                    var d = e.ownerDocument.createTextNode(i.INVISIBLE_SPACE),
                        u = e.editorDocument.createElement("span"),
                        p = /^(IMG|BR|IFRAME|SCRIPT|INPUT|TEXTAREA|TABLE|HR)$/,
                        f = function(e) {
                    ...
                    try {
                        ...
                        var h = s.Dom.up(d, s.Dom.isBlock, e.editor),
                            m = s.Dom.findInline(d, a, e.editor);
                        if (m) {
                            var v = {
                                node: m
                            };
        ...
        function n(e) {
            ...
            e.events.on("change afterSetMode afterInit mousedown keydown", s.debounce(function() {
                ...
                if (e.selection.isCollapsed()) {
                    var t = e.selection.current();
                    if (t && t.nodeType === Node.TEXT_NODE && t.nodeValue !== r.INVISIBLE_SPACE)
                        for (; t = a.Dom.findInline(t, !0, e.editor);) t && t.nodeType === Node.TEXT_NODE && t.nodeValue && t.nodeValue.match(r.INVISIBLE_SPACE_REG_EXP) && (t.nodeValue = t.nodeValue.replace(r.INVISIBLE_SPACE_REG_EXP, ""))
                }
        ...
        l.Config.prototype.toolbarInline = !0, l.Config.prototype.toolbarInlineDisableFor = [], l.Config.prototype.popup = {
            ...
            function t(t) {
                ...
                return o.isShown = !1, o.calcWindSizes = function() {
                    ...
                    var i = o.container.offsetWidth / 2,
                        r = -i;
        ...
        function n(e) {
            var t, o, n, i, a, l, c, d, u, p, f, h = !1,
                ...
                C = function() {
                    if (v && o && _) {
                        var t = s.offset(o, e, e.editorDocument),
                            n = parseInt(_.style.left || "0", 10),
                            i = parseInt(_.style.top || "0", 10),
                            r = _.offsetWidth,
                            a = _.offsetHeight;
        ...
        Object.defineProperty(t, "__esModule", {
            ...
            "contains detailed help for using": "beinhaltet ausfÃ¼hrliche Informationen wie Sie den Editor verwenden kÃ¶nnen.",
            "For information about the license, please go to our website:": "FÃ¼r Lizenz-Informationen, besuchen Sie bitte unsere Webseite:",
            ...
            Anchor: "Anker",
            "Open in new tab": "In neuer Registerkarte Ã¶ffnen",
            "Open editor in fullsize": "Editor in voller GrÃ¶ÃŸe Ã¶ffnen",
            "Clear Formatting": "Formatierung lÃ¶schen",
            "Fill color or set the text color": "FÃ¼llfarbe oder Textfarbe Ã¤ndern",
            Redo: "Wiederholen",
            Undo: "RÃ¼ckgÃ¤ngig machen",
            Bold: "Fett",
            Italic: "Kursiv",
            "Insert Unordered List": "Ungeordnete Liste einfÃ¼gen",
            "Insert Ordered List": "Sortierte Liste einfÃ¼gen",
            "Align Center": "Mittig ausrichten",
            "Align Justify": "Blocksatz",
            "Align Left": "Links ausrichten",
            "Align Right": "Rechts ausrichten",
            "Insert Horizontal Line": "Horizontale Linie einfÃ¼gen",
            "Insert Image": "Bild einfÃ¼gen",
            "Insert file": "Datei einfÃ¼gen",
            "Insert youtube/vimeo video": "Youtube/vimeo Video einfÃ¼gen",
            "Insert link": "Link einfÃ¼gen",
            "Font size": "SchriftgrÃ¶ÃŸe",
            "Font family": "Schriftfamilie",
            "Insert format block": "Formatblock einfÃ¼gen",
            Normal: "Normal",
            ...
            "Select Special Character": "Sonderzeichen auswÃ¤hlen",
            "Insert Special Character": "Sonderzeichen einfÃ¼gen",
            "Paint format": "Format kopieren",
            "Change mode": "Ã„nderungsmodus",
            Margins: "RÃ¤nder",
            top: "Oben",
            right: "Rechts",
            bottom: "Unten",
            ...
            Cancel: "Abbrechen",
            Ok: "OK",
            "Your code is similar to HTML. Keep as HTML?": "Es scheint als dass Sie HTML-Text einfÃ¼gen mÃ¶chten",
            "Paste as HTML": "Als HTML einfÃ¼gen?",
            Keep: "Original speichern",
            Clean: "SÃ¤ubern",
            "Insert as Text": "Als Text einfÃ¼gen",
            "Word Paste Detected": "InWord formatierter Text erkannt",
            "The pasted content is coming from a Microsoft Word/Excel document. Do you want to keep the format or clean it up?": "Der Inhalt, den Sie einfÃ¼gen, stammt aus einem Microsoft Word / Excel-Dokument. MÃ¶chten Sie das Format erhalten oder lÃ¶schen?",
            "Insert only Text": "Als Text einfÃ¼gen",
            ...
            Middle: "Mittig",
            Bottom: "Unten",
            "Insert column before": "Spalte einfÃ¼gen vor",
            "Insert column after": "Spalte einfÃ¼gen nach",
            "Insert row above": "Zeile einfÃ¼gen oberhalb",
            "Insert row below": "Zeile unterhalb einfÃ¼gen",
            ...
            Filter: "filter",
            "Sort by changed": "Sortieren nach geÃ¤ndert",
            "Sort by name": "Nach Name sortieren",
            "Sort by size": "Nach GrÃ¶ÃŸe sortiert",
            "Add folder": "Ordner hinzufÃ¼gen",
            "Split vertical": "Split vertikal",
            "Split horizontal": "Split horizontally",
            Merge: "Verschmelzen",
            "Add column": "Spalte hinzufÃ¼gen",
            ...
            Paste: "EinfÃ¼gen",
            "Choose Content to Paste": "WÃ¤hlen Sie Inhalt zum EinfÃ¼gen",
            "Chars: %d": "Zeichen: %d",
            "Words: %d": "WÃ¶rter: %d",
            All: "WÃ¤hlen Sie Alle aus",
            "Select %s": "Markieren: %s",
            "Select all": "WÃ¤hlen Sie Alle aus",
            source: "HTML",
            bold: "Fett gedruckt",
            italic: "kursiv",
            brush: "BÃ¼rste",
            ...
            cut: "Schnitt",
            selectall: "WÃ¤hlen Sie Alle aus",
            ...
            Resize: "Ã„ndern Sie die GrÃ¶ÃŸe",
            Crop: "GrÃ¶ÃŸe anpassen",
            Width: "Breite",
            Height: "HÃ¶he",
            ...
            Remove: "Entfernen",
            Select: "Markieren",
            "You can only edit your own images. Download this image on the host?": "Sie kÃ¶nnen nur Ihre eigenen Bilder bearbeiten. Laden Sie dieses Bild auf dem Host herunter?",
        ...
        Object.defineProperty(t, "__esModule", {
            ...
            "contains detailed help for using": "Aide dÃ©taillÃ©e Ã  l'utilisation",
            "For information about the license, please go to our website:": "Consulter la licence sur notre site web:",
            "Buy full version": "Acheter la version complÃ¨te",
            "Copyright Â© XDSoft.net - Chupurnov Valeriy. All rights reserved.": "Copyright Â© XDSoft.net - Chupurnov Valeriy. Tous droits rÃ©servÃ©s.",
            Anchor: "Ancre",
            "Open in new tab": "Ouvrir dans un nouvel onglet",
            "Open editor in fullsize": "Ouvrir l'Ã©diteur en pleine page",
            ...
            Bold: "Gras",
            Italic: "Italique",
            "Insert Unordered List": "Liste non ordonnÃ©e",
            "Insert Ordered List": "Liste ordonnÃ©e",
            "Align Center": "Centrer",
            "Align Justify": "Justifier",
            "Align Left": "Aligner Ã  gauche ",
            "Align Right": "Aligner Ã  droite",
            "Insert Horizontal Line": "InsÃ©rer une ligne horizontale",
            "Insert Image": "InsÃ©rer une image",
            "Insert file": "InsÃ©rer un fichier",
            "Insert youtube/vimeo video": "InsÃ©rer une vidÃ©o",
            "Insert link": "InsÃ©rer un lien",
            "Font size": "Taille des caractÃ¨res",
            "Font family": "Famille des caractÃ¨res",
            "Insert format block": "Bloc formattÃ©",
            Normal: "Normal",
            "Heading 1": "Titre 1",
            "Heading 2": "Titre 2",
            "Heading 3": "Titre 3",
            ...
            "Select Special Character": "SÃ©lectionnez un caractÃ¨re spÃ©cial",
            "Insert Special Character": "InsÃ©rer un caractÃ¨re spÃ©cial",
            ...
            file: "fichier",
            Advanced: "AvancÃ©",
            "Image properties": "PropriÃ©tÃ©s de l'image",
            Cancel: "Effacer",
            Ok: "OK",
            ...
            "Word Paste Detected": "C'est peut-Ãªtre un fragment de Word ou Excel",
            "The pasted content is coming from a Microsoft Word/Excel document. Do you want to keep the format or clean it up?": "Le contenu que vous insÃ©rez provient d'un document Microsoft Word / Excel. Voulez-vous enregistrer le format ou l'effacer?",
            ...
            "Insert row above": "InsÃ©rer une ligne en dessus",
            "Insert row below": "InsÃ©rer une ligne en dessous",
            ...
            "Chars: %d": "Symboles: %d",
            "Words: %d": "Mots: %d",
            "Strike through": "Frapper Ã  travers",
            Underline: "Souligner",
            ...
            Replace: "Remplacer",
            Paste: "Coller",
            "Choose Content to Paste": "Choisissez le contenu Ã  coller",
            source: "la source",
            bold: "graisseux",
            italic: "italique",
            brush: "verser",
            ...
            video: "Video",
            font: "police",
            about: "Ã  propos de l'Ã©diteur",
            print: "impression",
            symbol: "caractÃ¨re",
            underline: "soulignÃ©",
            strikethrough: "barrÃ©",
            indent: "indentation",
            outdent: "indiffÃ©rent",
            fullsize: "taille rÃ©elle",
            ...
            No: "Non",
            Remove: "Supprimer",
            Select: "Mettre en Ã©vidence",
            "Select %s": "Mettre en Ã©vidence: %s",
            Update: "Mettre Ã  jour",
            "Vertical align": "Alignement vertical",
            Merge: "aller",
            "Add column": "Ajouter une colonne",
            "Add row": "Ajouter une rangÃ©e",
            Delete: "Effacer",
            "Horizontal align": "Alignement horizontal",
            "Sort by changed": "Trier par modifiÃ©",
            "Sort by name": "Trier par nom",
            "Sort by size": "Classer par taille",
            "Add folder": "Ajouter le dossier",
            "You can only edit your own images. Download this image on the host?": "Vous ne pouvez Ã©diter que vos propres images. TÃ©lÃ©chargez cette image sur l'hÃ´te?",
            "The image has been successfully uploaded to the host!": "L'image a Ã©tÃ© tÃ©lÃ©chargÃ©e avec succÃ¨s sur le serveur!null"
        }
    }, function(e, t, o) {
        "use strict";
        Object.defineProperty(t, "__esModule", {
            ...
            "Type something": "ÐÐ°Ð¿Ð¸ÑˆÐ¸Ñ‚Ðµ Ñ‡Ñ‚Ð¾-Ð»Ð¸Ð±Ð¾",
            "About Jodit": "Ðž Jodit",
            "Jodit Editor": "Ð ÐµÐ´Ð°ÐºÑ‚Ð¾Ñ€ Jodit",
            "Free Non-commercial Version": "Ð’ÐµÑ€ÑÐ¸Ñ Ð´Ð»Ñ Ð½Ðµ ÐºÐ¾Ð¼Ð¼ÐµÑ€Ñ‡ÐµÑÐºÐ¾Ð³Ð¾ Ð¸ÑÐ¿Ð¾Ð»ÑŒÐ·Ð¾Ð²Ð°Ð½Ð¸Ñ",
            "Jodit User's Guide": "Jodit Ð ÑƒÐºÐ¾Ð²Ð¾Ð´ÑÑ‚Ð²Ð¾ Ð¿Ð¾Ð»ÑŒÐ·Ð¾Ð²Ð°Ñ‚ÐµÐ»Ñ",
            "contains detailed help for using": "ÑÐ¾Ð´ÐµÑ€Ð¶Ð¸Ñ‚ Ð´ÐµÑ‚Ð°Ð»ÑŒÐ½ÑƒÑŽ Ð¸Ð½Ñ„Ð¾Ñ€Ð¼Ð°Ñ†Ð¸ÑŽ Ð¿Ð¾ Ð¸ÑÐ¿Ð¾Ð»ÑŒÐ·Ð¾Ð²Ð°Ð½Ð¸ÑŽ",
            "For information about the license, please go to our website:": "Ð”Ð»Ñ Ð¿Ð¾Ð»ÑƒÑ‡ÐµÐ½Ð¸Ñ ÑÐ²ÐµÐ´ÐµÐ½Ð¸Ð¹ Ð¾ Ð»Ð¸Ñ†ÐµÐ½Ð·Ð¸Ð¸ , Ð¿Ð¾Ð¶Ð°Ð»ÑƒÐ¹ÑÑ‚Ð°, Ð¿ÐµÑ€ÐµÐ¹Ð´Ð¸Ñ‚Ðµ Ð½Ð° Ð½Ð°Ñˆ ÑÐ°Ð¹Ñ‚:",
            "Buy full version": "ÐšÑƒÐ¿Ð¸Ñ‚ÑŒ Ð¿Ð¾Ð»Ð½ÑƒÑŽ Ð²ÐµÑ€ÑÐ¸ÑŽ",
            "Copyright Â© XDSoft.net - Chupurnov Valeriy. All rights reserved.": "ÐÐ²Ñ‚Ð¾Ñ€ÑÐºÐ¸Ðµ Ð¿Ñ€Ð°Ð²Ð° Â© XDSoft.net - Ð§ÑƒÐ¿ÑƒÑ€Ð½Ð¾Ð² Ð’Ð°Ð»ÐµÑ€Ð¸Ð¹. Ð’ÑÐµ Ð¿Ñ€Ð°Ð²Ð° Ð·Ð°Ñ‰Ð¸Ñ‰ÐµÐ½Ñ‹.",
            Anchor: "ÐÐ½ÐºÐ¾Ñ€",
            "Open in new tab": "ÐžÑ‚ÐºÑ€Ñ‹Ð²Ð°Ñ‚ÑŒ ÑÑÑ‹Ð»ÐºÑƒ Ð² Ð½Ð¾Ð²Ð¾Ð¹ Ð²ÐºÐ»Ð°Ð´ÐºÐµ",
            "Open editor in fullsize": "ÐžÑ‚ÐºÑ€Ñ‹Ñ‚ÑŒ Ñ€ÐµÐ´Ð°ÐºÑ‚Ð¾Ñ€ Ð² Ð¿Ð¾Ð»Ð½Ð¾Ð¼ Ñ€Ð°Ð·Ð¼ÐµÑ€Ðµ",
            "Clear Formatting": "ÐžÑ‡Ð¸ÑÑ‚Ð¸Ñ‚ÑŒ Ñ„Ð¾Ñ€Ð¼Ð°Ñ‚Ð¸Ñ€Ð¾Ð²Ð°Ð½Ð¸Ðµ",
            "Fill color or set the text color": "Ð¦Ð²ÐµÑ‚ Ð·Ð°Ð»Ð¸Ð²ÐºÐ¸ Ð¸Ð»Ð¸ Ñ†Ð²ÐµÑ‚ Ñ‚ÐµÐºÑÑ‚Ð°",
            Redo: "ÐŸÐ¾Ð²Ñ‚Ð¾Ñ€",
            Undo: "ÐžÑ‚Ð¼ÐµÐ½Ð°",
            Bold: "Ð–Ð¸Ñ€Ð½Ñ‹Ð¹",
            Italic: "ÐÐ°ÐºÐ»Ð¾Ð½Ð½Ñ‹Ð¹",
            "Insert Unordered List": "Ð’ÑÑ‚Ð°Ð²ÐºÐ° Ð¼Ð°Ñ€ÐºÐ¸Ñ€Ð¾Ð²Ð°Ð½Ð½Ð¾Ð³Ð¾ ÑÐ¿Ð¸ÑÐºÐ°",
            "Insert Ordered List": "Ð’ÑÑ‚Ð°Ð²Ð¸Ñ‚ÑŒ Ð½ÑƒÐ¼ÐµÑ€Ð¾Ð²Ð°Ð½Ð½Ñ‹Ð¹ ÑÐ¿Ð¸ÑÐ¾Ðº",
            "Align Center": "Ð’Ñ‹Ñ€Ð¾Ð²Ð½ÑÑ‚ÑŒ Ð¿Ð¾ Ñ†ÐµÐ½Ñ‚Ñ€Ñƒ",
            "Align Justify": "Ð’Ñ‹Ñ€Ð¾Ð²Ð½ÑÑ‚ÑŒ Ð¿Ð¾ ÑˆÐ¸Ñ€Ð¸Ð½Ðµ",
            "Align Left": "Ð’Ñ‹Ñ€Ð¾Ð²Ð½ÑÑ‚ÑŒ Ð¿Ð¾ Ð»ÐµÐ²Ð¾Ð¼Ñƒ ÐºÑ€Ð°ÑŽ",
            "Align Right": "Ð’Ñ‹Ñ€Ð¾Ð²Ð½ÑÑ‚ÑŒ Ð¿Ð¾ Ð¿Ñ€Ð°Ð²Ð¾Ð¼Ñƒ ÐºÑ€Ð°ÑŽ",
            "Insert Horizontal Line": "Ð’ÑÑ‚Ð°Ð²Ð¸Ñ‚ÑŒ Ð³Ð¾Ñ€Ð¸Ð·Ð¾Ð½Ñ‚Ð°Ð»ÑŒÐ½ÑƒÑŽ Ð»Ð¸Ð½Ð¸ÑŽ",
            "Insert Image": "Ð’ÑÑ‚Ð°Ð²Ð¸Ñ‚ÑŒ Ð¸Ð·Ð¾Ð±Ñ€Ð°Ð¶ÐµÐ½Ð¸Ðµ",
            "Insert file": "Ð’ÑÑ‚Ð°Ð²Ð¸Ñ‚ÑŒ Ñ„Ð°Ð¹Ð»",
            "Insert youtube/vimeo video": "Ð’ÑÑ‚Ð°Ð²ÑŒÑ‚Ðµ Ð²Ð¸Ð´ÐµÐ¾",
            "Insert link": "Ð’ÑÑ‚Ð°Ð²Ð¸Ñ‚ÑŒ ÑÑÑ‹Ð»ÐºÑƒ",
            "Font size": "Ð Ð°Ð·Ð¼ÐµÑ€ ÑˆÑ€Ð¸Ñ„Ñ‚Ð°",
            "Font family": "Ð¨Ñ€Ð¸Ñ„Ñ‚",
            "Insert format block": "Ð’ÑÑ‚Ð°Ð²Ð¸Ñ‚ÑŒ Ð±Ð»Ð¾Ñ‡Ð½Ñ‹Ð¹ ÑÐ»ÐµÐ¼ÐµÐ½Ñ‚",
            Normal: "ÐÐ¾Ñ€Ð¼Ð°Ð»ÑŒÐ½Ñ‹Ð¹ Ñ‚ÐµÐºÑÑ‚",
            ...
            "Decrease Indent": "Ð£Ð¼ÐµÐ½ÑŒÑˆÐ¸Ñ‚ÑŒ Ð¾Ñ‚ÑÑ‚ÑƒÐ¿",
            "Increase Indent": "Ð£Ð²ÐµÐ»Ð¸Ñ‡Ð¸Ñ‚ÑŒ Ð¾Ñ‚ÑÑ‚ÑƒÐ¿",
            "Select Special Character": "Ð’Ñ‹Ð±ÐµÑ€Ð¸Ñ‚Ðµ ÑÐ¿ÐµÑ†Ð¸Ð°Ð»ÑŒÐ½Ñ‹Ð¹ ÑÐ¸Ð¼Ð²Ð¾Ð»",
            "Insert Special Character": "Ð’ÑÑ‚Ð°Ð²Ð¸Ñ‚ÑŒ ÑÐ¿ÐµÑ†Ð¸Ð°Ð»ÑŒÐ½Ñ‹Ð¹ ÑÐ¸Ð¼Ð²Ð¾Ð»",
            "Paint format": "Ð¤Ð¾Ñ€Ð¼Ð°Ñ‚ ÐºÑ€Ð°ÑÐºÐ¸",
            "Change mode": "Ð˜ÑÑ‚Ð¾Ñ‡Ð½Ð¸Ðº",
            Margins: "ÐžÑ‚ÑÑ‚ÑƒÐ¿Ñ‹",
            top: "ÑÐ²ÐµÑ€Ñ…Ñƒ",
            right: "ÑÐ¿Ñ€Ð°Ð²Ð°",
            bottom: "ÑÐ½Ð¸Ð·Ñƒ",
            left: "ÑÐ»ÐµÐ²Ð°",
            ...
            Right: "ÐŸÐ¾ Ð¿Ñ€Ð°Ð²Ð¾Ð¼Ñƒ ÐºÑ€Ð°ÑŽ",
            Center: "ÐŸÐ¾ Ñ†ÐµÐ½Ñ‚Ñ€Ñƒ",
            Left: "ÐŸÐ¾ Ð»ÐµÐ²Ð¾Ð¼Ñƒ ÐºÑ€Ð°ÑŽ",
            "--Not Set--": "--Ð½Ðµ ÑƒÑÑ‚Ð°Ð½Ð°Ð²Ð»Ð¸Ð²Ð°Ñ‚ÑŒ--",
            Src: "src",
            Title: "Ð—Ð°Ð³Ð¾Ð»Ð¾Ð²Ð¾Ðº",
            Alternative: "ÐÐ»ÑŒÑ‚ÐµÑ€Ð½Ð°Ñ‚Ð¸Ð²Ð½Ñ‹Ð¹ Ñ‚ÐµÐºÑÑ‚ (alt)",
            Link: "Ð¡ÑÑ‹Ð»ÐºÐ°",
            "Open link in new tab": "ÐžÑ‚ÐºÑ€Ñ‹Ð²Ð°Ñ‚ÑŒ ÑÑÑ‹Ð»ÐºÑƒ Ð² Ð½Ð¾Ð²Ð¾Ð¼ Ð¾ÐºÐ½Ðµ",
            Image: "Ð˜Ð·Ð¾Ð±Ñ€Ð°Ð¶ÐµÐ½Ð¸Ðµ",
            file: "Ð¤Ð°Ð¹Ð»",
            Advanced: "Ð Ð°ÑÑˆÐ¸Ñ€ÐµÐ½Ð½Ñ‹Ðµ",
            "Image properties": "Ð¡Ð²Ð¾Ð¹ÑÑ‚Ð²Ð° Ð¸Ð·Ð¾Ð±Ñ€Ð°Ð¶ÐµÐ½Ð¸Ñ",
            Cancel: "ÐžÑ‚Ð¼ÐµÐ½Ð°",
            Ok: "ÐžÐº",
            "Your code is similar to HTML. Keep as HTML?": "Ð’Ð°Ñˆ Ñ‚ÐµÐºÑÑ‚, ÐºÐ¾Ñ‚Ð¾Ñ€Ñ‹Ð¹ Ð²Ñ‹ Ð¿Ñ‹Ñ‚Ð°ÐµÑ‚ÐµÑÑŒ Ð²ÑÑ‚Ð°Ð²Ð¸Ñ‚ÑŒ Ð¿Ð¾Ñ…Ð¾Ð¶ Ð½Ð° HTML. Ð’ÑÑ‚Ð°Ð²Ð¸Ñ‚ÑŒ ÐµÐ³Ð¾ ÐºÐ°Ðº HTML?",
            "Paste as HTML": "Ð’ÑÑ‚Ð°Ð²Ð¸Ñ‚ÑŒ ÐºÐ°Ðº HTML?",
            Keep: "Ð¡Ð¾Ñ…Ñ€Ð°Ð½Ð¸Ñ‚ÑŒ Ð¾Ñ€Ð¸Ð³Ð¸Ð½Ð°Ð»",
            Clean: "ÐŸÐ¾Ñ‡Ð¸ÑÑ‚Ð¸Ñ‚ÑŒ",
            "Insert as Text": "Ð’ÑÑ‚Ð°Ð²Ð¸Ñ‚ÑŒ ÐºÐ°Ðº Ñ‚ÐµÐºÑÑ‚",
            "Insert only Text": "Ð’ÑÑ‚Ð°Ð²Ð¸Ñ‚ÑŒ Ñ‚Ð¾Ð»ÑŒÐºÐ¾ Ñ‚ÐµÐºÑÑ‚",
            "Word Paste Detected": "Ð’Ð¾Ð·Ð¼Ð¾Ð¶Ð½Ð¾ ÑÑ‚Ð¾ Ñ„Ñ€Ð°Ð³Ð¼ÐµÐ½Ñ‚ Word Ð¸Ð»Ð¸ Excel",
            "The pasted content is coming from a Microsoft Word/Excel document. Do you want to keep the format or clean it up?": "ÐšÐ¾Ð½Ñ‚ÐµÐ½Ñ‚ ÐºÐ¾Ñ‚Ð¾Ñ€Ñ‹Ð¹ Ð²Ñ‹ Ð²ÑÑ‚Ð°Ð²Ð»ÑÐµÑ‚Ðµ Ð¿Ð¾ÑÑ‚ÑƒÐ¿Ð°ÐµÑ‚ Ð¸Ð· Ð´Ð¾ÐºÑƒÐ¼ÐµÐ½Ñ‚Ð° Microsoft Word / Excel. Ð’Ñ‹ Ñ…Ð¾Ñ‚Ð¸Ñ‚Ðµ ÑÐ¾Ñ…Ñ€Ð°Ð½Ð¸Ñ‚ÑŒ Ñ„Ð¾Ñ€Ð¼Ð°Ñ‚ Ð¸Ð»Ð¸ Ð¾Ñ‡Ð¸ÑÑ‚Ð¸Ñ‚ÑŒ ÐµÐ³Ð¾?",
            "File Browser": "Ð‘Ñ€Ð°ÑƒÐ·ÐµÑ€ Ñ„Ð°Ð¹Ð»Ð¾Ð²",
            "Error on load list": "ÐžÑˆÐ¸Ð±ÐºÐ° Ð¿Ñ€Ð¸ Ð·Ð°Ð³Ñ€ÑƒÐ·ÐºÐµ ÑÐ¿Ð¸ÑÐºÐ° Ð¸Ð·Ð¾Ð±Ñ€Ð°Ð¶ÐµÐ½Ð¸Ð¹",
            "Error on load folders": "ÐžÑˆÐ¸Ð±ÐºÐ° Ð¿Ñ€Ð¸ Ð·Ð°Ð³Ñ€ÑƒÐ·ÐºÐµ ÑÐ¿Ð¸ÑÐºÐ° Ð´Ð¸Ñ€ÐµÐºÑ‚Ð¾Ñ€Ð¸Ð¹",
            "Are you shure?": "Ð’Ñ‹ ÑƒÐ²ÐµÑ€ÐµÐ½Ñ‹?",
            "Enter Directory name": "Ð’Ð²ÐµÐ´Ð¸Ñ‚Ðµ Ð½Ð°Ð·Ð²Ð°Ð½Ð¸Ðµ Ð´Ð¸Ñ€ÐµÐºÑ‚Ð¾Ñ€Ð¸Ð¸",
            "Create directory": "Ð¡Ð¾Ð·Ð´Ð°Ñ‚ÑŒ Ð´Ð¸Ñ€ÐµÐºÑ‚Ð¾Ñ€Ð¸ÑŽ",
            "type name": "Ð²Ð²ÐµÐ´Ð¸Ñ‚Ðµ Ð½Ð°Ð·Ð²Ð°Ð½Ð¸Ðµ",
            "Drop image": "ÐŸÐµÑ€ÐµÑ‚Ð°Ñ‰Ð¸Ñ‚Ðµ ÑÑŽÐ´Ð° Ð¸Ð·Ð¾Ð±Ñ€Ð°Ð¶ÐµÐ½Ð¸Ðµ",
            "Drop file": "ÐŸÐµÑ€ÐµÑ‚Ð°Ñ‰Ð¸Ñ‚Ðµ ÑÑŽÐ´Ð° Ñ„Ð°Ð¹Ð»",
            "or click": "Ð¸Ð»Ð¸ Ð½Ð°Ð¶Ð¼Ð¸Ñ‚Ðµ",
            "Alternative text": "ÐÐ»ÑŒÑ‚ÐµÑ€Ð½Ð°Ñ‚Ð¸Ð²Ð½Ñ‹Ð¹ Ñ‚ÐµÐºÑÑ‚",
            Browse: "Ð¡ÐµÑ€Ð²ÐµÑ€",
            Upload: "Ð—Ð°Ð³Ñ€ÑƒÐ·ÐºÐ°",
            Background: "Ð¤Ð¾Ð½",
            Text: "Ð¢ÐµÐºÑÑ‚",
            Top: " Ðš Ð²ÐµÑ€Ñ…Ñƒ",
            Middle: "ÐŸÐ¾ ÑÐµÑ€ÐµÐ´Ð¸Ð½Ðµ",
            Bottom: "Ðš Ð½Ð¸Ð·Ñƒ",
            "Insert column before": "Ð’ÑÑ‚Ð°Ð²Ð¸Ñ‚ÑŒ ÑÑ‚Ð¾Ð»Ð±ÐµÑ† Ð´Ð¾",
            "Insert column after": "Ð’ÑÑ‚Ð°Ð²Ð¸Ñ‚ÑŒ ÑÑ‚Ð¾Ð»Ð±ÐµÑ† Ð¿Ð¾ÑÐ»Ðµ",
            "Insert row above": "Ð’ÑÑ‚Ð°Ð²Ð¸Ñ‚ÑŒ Ñ€ÑÐ´ Ð²Ñ‹ÑˆÐµ",
            "Insert row below": "Ð’ÑÑ‚Ð°Ð²Ð¸Ñ‚ÑŒ Ñ€ÑÐ´ Ð½Ð¸Ð¶Ðµ",
            "Delete table": "Ð£Ð´Ð°Ð»Ð¸Ñ‚ÑŒ Ñ‚Ð°Ð±Ð»Ð¸Ñ†Ñƒ",
            "Delete row": "Ð£Ð´Ð°Ð»ÑÑ‚ÑŒ Ñ€ÑÐ´",
            "Delete column": "Ð£Ð´Ð°Ð»Ð¸Ñ‚ÑŒ ÑÑ‚Ð¾Ð»Ð±ÐµÑ†",
            "Empty cell": "ÐžÑ‚Ñ‡Ð¸ÑÑ‚Ð¸Ñ‚ÑŒ ÑÑ‡ÐµÐ¹ÐºÑƒ",
            source: "HTML",
            bold: "Ð¶Ð¸Ñ€Ð½Ñ‹Ð¹",
            italic: "ÐºÑƒÑ€ÑÐ¸Ð²",
            brush: "Ð·Ð°Ð»Ð¸Ð²ÐºÐ°",
            link: "ÑÑÑ‹Ð»ÐºÐ°",
            undo: "Ð¾Ñ‚Ð¼ÐµÐ½Ð¸Ñ‚ÑŒ",
            redo: "Ð¿Ð¾Ð²Ñ‚Ð¾Ñ€Ð¸Ñ‚ÑŒ",
            table: "Ñ‚Ð°Ð±Ð»Ð¸Ñ†Ð°",
            image: "Ð¸Ð·Ð¾Ð±Ñ€Ð°Ð¶ÐµÐ½Ð¸Ðµ",
            eraser: "Ð¾Ñ‡Ð¸ÑÑ‚Ð¸Ñ‚ÑŒ",
            paragraph: "Ð¿Ð°Ñ€Ð°Ð³Ñ€Ð°Ñ„",
            fontsize: "Ñ€Ð°Ð·Ð¼ÐµÑ€ ÑˆÑ€Ð¸Ñ„Ñ‚Ð°",
            video: "Ð²Ð¸Ð´ÐµÐ¾",
            font: "ÑˆÑ€Ð¸Ñ„Ñ‚",
            about: "Ð¾ Ñ€ÐµÐ´Ð°ÐºÑ‚Ð¾Ñ€Ðµ",
            print: "Ð¿ÐµÑ‡Ð°Ñ‚ÑŒ",
            symbol: "ÑÐ¸Ð¼Ð²Ð¾Ð»",
            underline: "Ð¿Ð¾Ð´Ñ‡ÐµÑ€ÐºÐ½ÑƒÑ‚Ñ‹Ð¹",
            strikethrough: "Ð¿ÐµÑ€ÐµÑ‡ÐµÑ€ÐºÐ½ÑƒÑ‚Ñ‹Ð¹",
            indent: "Ð¾Ñ‚ÑÑ‚ÑƒÐ¿",
            outdent: "Ð²Ñ‹ÑÑ‚ÑƒÐ¿",
            fullsize: "Ð²Ð¾ Ð²ÐµÑÑŒ ÑÐºÑ€Ð°Ð½",
            shrink: "Ð¾Ð±Ñ‹Ñ‡Ð½Ñ‹Ð¹ Ñ€Ð°Ð·Ð¼ÐµÑ€",
            copyformat: "ÐšÐ¾Ð¿Ð¸Ñ€Ð¾Ð²Ð°Ñ‚ÑŒ Ñ„Ð¾Ñ€Ð¼Ð°Ñ‚",
            hr: "Ð»Ð¸Ð½Ð¸Ñ",
            ul: "Ð¡Ð¿Ð¸ÑÐ¾Ðº",
            ol: "ÐÑƒÐ¼ÐµÑ€Ð¾Ð²Ð°Ð½Ð½Ñ‹Ð¹ ÑÐ¿Ð¸ÑÐ¾Ðº",
            cut: "Ð’Ñ‹Ñ€ÐµÐ·Ð°Ñ‚ÑŒ",
            selectall: "Ð’Ñ‹Ð´ÐµÐ»Ð¸Ñ‚ÑŒ Ð²ÑÐµ",
            "Embed code": "ÐšÐ¾Ð´",
            "Open link": "ÐžÑ‚ÐºÑ€Ñ‹Ñ‚ÑŒ ÑÑÑ‹Ð»ÐºÑƒ",
            "Edit link": "Ð ÐµÐ´Ð°ÐºÑ‚Ð¸Ñ€Ð¾Ð²Ð°Ñ‚ÑŒ ÑÑÑ‹Ð»ÐºÑƒ",
            "No follow": "ÐÑ‚Ñ€Ð¸Ð±ÑƒÑ‚ nofollow",
            Unlink: "Ð£Ð±Ñ€Ð°Ñ‚ÑŒ ÑÑÑ‹Ð»ÐºÑƒ",
            Update: "ÐžÐ±Ð½Ð¾Ð²Ð¸Ñ‚ÑŒ",
            " URL": "URL",
            Edit: "Ð ÐµÐ´Ð°ÐºÑ‚Ð¸Ñ€Ð¾Ð²Ð°Ñ‚ÑŒ",
            "Horizontal align": "Ð“Ð¾Ñ€Ð¸Ð·Ð¾Ð½Ñ‚Ð°Ð»ÑŒÐ½Ð¾Ðµ Ð²Ñ‹Ñ€Ð°Ð²Ð½Ð¸Ð²Ð°Ð½Ð¸Ðµ",
            Filter: "Ð¤Ð¸Ð»ÑŒÑ‚Ñ€",
            "Sort by changed": "ÐŸÐ¾ Ð¸Ð·Ð¼ÐµÐ½ÐµÐ½Ð¸ÑŽ",
            "Sort by name": "ÐŸÐ¾ Ð¸Ð¼ÐµÐ½Ð¸",
            "Sort by size": "ÐŸÐ¾ Ñ€Ð°Ð·Ð¼ÐµÑ€Ñƒ",
            "Add folder": "Ð”Ð¾Ð±Ð°Ð²Ð¸Ñ‚ÑŒ Ð¿Ð°Ð¿ÐºÑƒ",
            Reset: "Ð’Ð¾ÑÑÑ‚Ð°Ð½Ð¾Ð²Ð¸Ñ‚ÑŒ",
            Save: "Ð¡Ð¾Ñ…Ñ€Ð°Ð½Ð¸Ñ‚ÑŒ",
            "Save as ...": "Ð¡Ð¾Ñ…Ñ€Ð°Ð½Ð¸Ñ‚ÑŒ ÐºÐ°Ðº",
            Resize: "Ð˜Ð·Ð¼ÐµÐ½Ð¸Ñ‚ÑŒ Ñ€Ð°Ð·Ð¼ÐµÑ€",
            Crop: "ÐžÐ±Ñ€ÐµÐ·Ð°Ñ‚ÑŒ Ñ€Ð°Ð·Ð¼ÐµÑ€",
            Width: "Ð¨Ð¸Ñ€Ð¸Ð½Ð°",
            Height: "Ð’Ñ‹ÑÐ¾Ñ‚Ð°",
            "Keep Aspect Ratio": "Ð¡Ð¾Ñ…Ñ€Ð°Ð½ÑÑ‚ÑŒ Ð¿Ñ€Ð¾Ð¿Ð¾Ñ€Ñ†Ð¸Ð¸",
            Yes: "Ð”Ð°",
            No: "ÐÐµÑ‚",
            Remove: "Ð£Ð´Ð°Ð»Ð¸Ñ‚ÑŒ",
            Select: "Ð’Ñ‹Ð´ÐµÐ»Ð¸Ñ‚ÑŒ",
            "Chars: %d": "Ð¡Ð¸Ð¼Ð²Ð¾Ð»Ð¾Ð²: %d",
            "Words: %d": "Ð¡Ð»Ð¾Ð²: %d",
            All: "Ð’Ñ‹Ð´ÐµÐ»Ð¸Ñ‚ÑŒ Ð²ÑÐµ",
            "Select %s": "Ð’Ñ‹Ð´ÐµÐ»Ð¸Ñ‚ÑŒ: %s",
            "Select all": "Ð’Ñ‹Ð´ÐµÐ»Ð¸Ñ‚ÑŒ Ð²ÑÐµ",
            "Vertical align": "Ð’ÐµÑ€Ñ‚Ð¸ÐºÐ°Ð»ÑŒÐ½Ð¾Ðµ Ð²Ñ‹Ñ€Ð°Ð²Ð½Ð¸Ð²Ð°Ð½Ð¸Ðµ",
            Split: "Ð Ð°Ð·Ð´ÐµÐ»Ð¸Ñ‚ÑŒ",
            "Split vertical": "Ð Ð°Ð·Ð´ÐµÐ»Ð¸Ñ‚ÑŒ Ð¿Ð¾ Ð²ÐµÑ€Ñ‚Ð¸ÐºÐ°Ð»Ð¸",
            "Split horizontal": "Ð Ð°Ð·Ð´ÐµÐ»Ð¸Ñ‚ÑŒ Ð¿Ð¾ Ð³Ð¾Ñ€Ð¸Ð·Ð¾Ð½Ñ‚Ð°Ð»Ð¸",
            Merge: "ÐžÐ±ÑŠÐµÐ´ÐµÐ½Ð¸Ñ‚ÑŒ Ð² Ð¾Ð´Ð½Ñƒ",
            "Add column": "Ð”Ð¾Ð±Ð°Ð²Ð¸Ñ‚ÑŒ ÑÑ‚Ð¾Ð»Ð±ÐµÑ†",
            "Add row": "Ð”Ð¾Ð±Ð°Ð²Ð¸Ñ‚ÑŒ ÑÑ‚Ñ€Ð¾ÐºÑƒ",
            Delete: "Ð£Ð´Ð°Ð»Ð¸Ñ‚ÑŒ",
            Border: "Ð Ð°Ð¼ÐºÐ°",
            "License: %s": "Ð›Ð¸Ñ†ÐµÐ½Ð·Ð¸Ñ: %s",
            "Strike through": "ÐŸÐµÑ€ÐµÑ‡ÐµÑ€ÐºÐ½ÑƒÑ‚ÑŒ",
            Underline: "ÐŸÐ¾Ð´Ñ‡ÐµÑ€ÐºÐ¸Ð²Ð°Ð½Ð¸Ðµ",
            superscript: "Ð²ÐµÑ€Ñ…Ð½Ð¸Ð¹ Ð¸Ð½Ð´ÐµÐºÑ",
            subscript: "Ð¸Ð½Ð´ÐµÐºÑ",
            "Cut selection": "Ð’Ñ‹Ñ€ÐµÐ·Ð°Ñ‚ÑŒ",
            Break: "Ð Ð°Ð·Ð´ÐµÐ»Ð¸Ñ‚ÐµÐ»ÑŒ",
            "Search for": "ÐÐ°Ð¹Ñ‚Ð¸",
            "Replace with": "Ð—Ð°Ð¼ÐµÐ½Ð¸Ñ‚ÑŒ Ð½Ð°",
            Replace: "Ð—Ð°Ð¼ÐµÐ½Ð¸Ñ‚ÑŒ",
            Paste: "Ð’ÑÑ‚Ð°Ð²Ð¸Ñ‚ÑŒ",
            "Choose Content to Paste": "Ð’Ñ‹Ð±Ñ€Ð°Ñ‚ÑŒ ÐºÐ¾Ð½Ñ‚ÐµÐ½Ñ‚ Ð´Ð»Ñ Ð²ÑÑ‚Ð°Ð²ÐºÐ¸",
            "You can only edit your own images. Download this image on the host?": "Ð’Ñ‹ Ð¼Ð¾Ð¶ÐµÑ‚Ðµ Ñ€ÐµÐ´Ð°ÐºÑ‚Ð¸Ñ€Ð¾Ð²Ð°Ñ‚ÑŒ Ñ‚Ð¾Ð»ÑŒÐºÐ¾ ÑÐ²Ð¾Ð¸ ÑÐ¾Ð±ÑÑ‚Ð²ÐµÐ½Ð½Ñ‹Ðµ Ð¸Ð·Ð¾Ð±Ñ€Ð°Ð¶ÐµÐ½Ð¸Ñ. Ð—Ð°Ð³Ñ€ÑƒÐ·Ð¸Ñ‚ÑŒ ÑÑ‚Ð¾ Ð¸Ð·Ð¾Ð±Ñ€Ð°Ð¶ÐµÐ½Ð¸Ðµ Ð½Ð° Ð²Ð°Ñˆ ÑÐµÑ€Ð²ÐµÑ€?",
            "The image has been successfully uploaded to the host!": "Ð˜Ð·Ð¾Ð±Ñ€Ð°Ð¶ÐµÐ½Ð¸Ðµ ÑƒÑÐ¿ÐµÑˆÐ½Ð¾ Ð·Ð°Ð³Ñ€ÑƒÐ¶ÐµÐ½Ð¾ Ð½Ð° ÑÐµÑ€Ð²ÐµÑ€!"
        }
    }, function(e, t, o) {
        "use strict";
        Object.defineProperty(t, "__esModule", {
            ...
            "Type something": "Ø¥Ø¨Ø¯Ø£ ÙÙŠ Ø§Ù„ÙƒØªØ§Ø¨Ø©...",
            "About Jodit": "Ø­ÙˆÙ„ Ø¬ÙˆØ¯ÙŠØª",
            "Jodit Editor": "Ù…Ø­Ø±Ø± Ø¬ÙˆØ¯ÙŠØª",
            "Free Non-commercial Version": "Ø§Ù„Ø¥ØµØ¯Ø§Ø± Ø§Ù„ØºÙŠØ± ØªØ¬Ø§Ø±ÙŠ Ù…Ø¬Ø§Ù†ÙŠ",
            "Jodit User's Guide": "Ø¯Ù„ÙŠÙ„ Ù…Ø³ØªØ®Ø¯Ù… Ø¬ÙˆØ¯ÙŠØª",
            "contains detailed help for using": "ÙŠØ­ØªÙˆÙŠ Ø¹Ù„Ù‰ Ù…Ø³Ø§Ø¹Ø¯Ø© Ù…ÙØµÙ„Ø© Ù„Ù„Ø§Ø³ØªØ®Ø¯Ø§Ù…",
            "For information about the license, please go to our website:": "Ù„Ù„Ø­ØµÙˆÙ„ Ø¹Ù„Ù‰ Ù…Ø¹Ù„ÙˆÙ…Ø§Øª Ø­ÙˆÙ„ Ø§Ù„ØªØ±Ø®ÙŠØµØŒ ÙŠØ±Ø¬Ù‰ Ø§Ù„Ø°Ù‡Ø§Ø¨ Ù„Ù…ÙˆÙ‚Ø¹Ù†Ø§:",
            ...
            "Open in new tab": "ÙØªØ­ ÙÙŠ Ù†Ø§ÙØ°Ø© Ø¬Ø¯ÙŠØ¯Ø©",
            "Open editor in fullsize": "ÙØªØ­ Ø§Ù„Ù…Ø­Ø±Ø± ÙÙŠ Ø§Ù„Ø­Ø¬Ù… Ø§Ù„ÙƒØ§Ù…Ù„",
            "Clear Formatting": "Ù…Ø³Ø­ Ø§Ù„ØªÙ†Ø³ÙŠÙ‚",
            "Fill color or set the text color": "Ù…Ù„Ø¡ Ø§Ù„Ù„ÙˆÙ† Ø£Ùˆ ØªØ¹ÙŠÙŠÙ† Ù„ÙˆÙ† Ø§Ù„Ù†Øµ",
            Redo: "Ø¥Ø¹Ø§Ø¯Ø©",
            Undo: "ØªØ±Ø§Ø¬Ø¹",
            Bold: "Ø¹Ø±ÙŠØ¶",
            Italic: "Ù…Ø§Ø¦Ù„",
            "Insert Unordered List": "Ø¥Ø¯Ø±Ø§Ø¬ Ù‚Ø§Ø¦Ù…Ø© ØºÙŠØ± Ù…Ø±ØªØ¨Ø©",
            "Insert Ordered List": "Ø¥Ø¯Ø±Ø§Ø¬ Ù‚Ø§Ø¦Ù…Ø© Ù…Ø±ØªØ¨Ø©",
            "Align Center": "Ù…Ø­Ø§Ø°Ø§Ø© Ù„Ù„ÙˆØ³Ø·",
            "Align Justify": "Ù…Ø­Ø§Ø°Ø§Ø© Ù…Ø«Ø¨ØªØ©",
            "Align Left": "Ù…Ø­Ø§Ø°Ø§Ø© Ù„Ù„ÙŠØ³Ø§Ø±",
            "Align Right": "Ù…Ø­Ø§Ø°Ø§Ø© Ù„Ù„ÙŠÙ…ÙŠÙ†",
            "Insert Horizontal Line": "Ø¥Ø¯Ø±Ø§Ø¬ Ø®Ø· Ø£ÙÙ‚ÙŠ",
            "Insert Image": "Ø¥Ø¯Ø±Ø§Ø¬ ØµÙˆØ±Ø©",
            "Insert file": "Ø§Ø¯Ø®Ø§Ù„ Ø§Ù„Ù…Ù„Ù",
            "Insert youtube/vimeo video": "Ø¥Ø¯Ø±Ø§Ø¬ ÙÙŠØ¯ÙŠÙˆ ÙŠÙˆØªÙŠÙˆØ¨/ÙÙŠÙ…ÙŠÙˆ ",
            "Insert link": "Ø¥Ø¯Ø±Ø§Ø¬ Ø±Ø§Ø¨Ø·",
            "Font size": "Ø­Ø¬Ù… Ø§Ù„Ø®Ø·",
            "Font family": "Ù†ÙˆØ¹ Ø§Ù„Ø®Ø·",
            "Insert format block": "Ø¥Ø¯Ø±Ø§Ø¬ ÙƒØªÙ„Ø© ØªÙ†Ø³ÙŠÙ‚",
            Normal: "Ø¹Ø§Ø¯ÙŠ",
            ...
            "Decrease Indent": "ØªÙ‚Ù„ÙŠÙ„ Ø§Ù„Ù…Ø³Ø§ÙØ© Ø§Ù„Ø¨Ø§Ø¯Ø¦Ø©",
            "Increase Indent": "Ø²ÙŠØ§Ø¯Ø© Ø§Ù„Ù…Ø³Ø§ÙØ© Ø§Ù„Ø¨Ø§Ø¯Ø¦Ø©",
            "Select Special Character": "ØªØ­Ø¯ÙŠØ¯ Ø£Ø­Ø±Ù Ø®Ø§ØµØ©",
            "Insert Special Character": "Ø¥Ø¯Ø±Ø§Ø¬ Ø­Ø±Ù Ø®Ø§Øµ",
            "Paint format": "ØªÙ†Ø³ÙŠÙ‚ Ø§Ù„Ø±Ø³Ù…",
            "Change mode": "ØªØºÙŠÙŠØ± Ø§Ù„ÙˆØ¶Ø¹",
            Margins: "Ù‡ÙˆØ§Ù…Ø´",
            top: "Ø£Ø¹Ù„Ù‰",
            right: "ÙŠÙ…ÙŠÙ†",
            bottom: "Ø£Ø³ÙÙ„",
            ...
            Center: "Ø§Ù„ÙˆØ³Ø·",
            Left: "Ø§Ù„ÙŠØ³Ø§Ø±",
            "--Not Set--": "--ØºÙŠØ± Ù…Ø¶Ø¨ÙˆØ·--",
            Src: "Src",
            Title: "Ø§Ù„Ø¹Ù†ÙˆØ§Ù†",
            Alternative: "Ø§Ù„Ø¹Ù†ÙˆØ§Ù† Ø§Ù„Ø¨Ø¯ÙŠÙ„",
            Link: "Ø§Ù„Ø±Ø§Ø¨Ø·",
            "Open link in new tab": "Ø§ÙØªØ­ Ø§Ù„Ø±Ø§Ø¨Ø· ÙÙŠ Ù†Ø§ÙØ°Ø© Ø¬Ø¯ÙŠØ¯Ø©",
            Image: "Ø§Ù„ØµÙˆØ±Ø©",
            file: "Ù…Ù„Ù",
            Advanced: "Ù…ØªÙ‚Ø¯Ù…",
            ...
            "Error on load list": "Ø­Ø¯Ø« Ø®Ø·Ø£ ÙÙŠ ØªØ­Ù…ÙŠÙ„ Ø§Ù„Ù‚Ø§Ø¦Ù…Ø© ",
            "Error on load folders": "Ø­Ø¯Ø« Ø®Ø·Ø£ ÙÙŠ ØªØ­Ù…ÙŠÙ„ Ø§Ù„Ù…Ø¬Ù„Ø¯Ø§Øª",
            "Are you shure?": "Ù‡Ù„ Ø£Ù†Øª ÙˆØ§Ø«Ù‚ØŸ",
            ...
            "Alternative text": "Ø§Ù„Ù†Øµ Ø§Ù„Ø¨Ø¯ÙŠÙ„",
            Upload: "Ø±ÙØ¹",
            Browse: "ØªØµÙØ­",
            ...
            "Empty cell": "Ø®Ù„ÙŠØ© ÙØ§Ø±ØºØ©",
            "Chars: %d": "%d Ø­Ø±Ù",
            "Words: %d": "%d ÙƒÙ„Ø§Ù…",
            "Strike through": "Ø§Ø¶Ø±Ø¨ Ù…Ù† Ø®Ù„Ø§Ù„",
            Underline: "Ø£ÙƒØ¯",
            superscript: "Ø­Ø±Ù ÙÙˆÙ‚ÙŠ",
            subscript: "Ù…Ø®Ø·ÙˆØ·Ø©",
            "Cut selection": "Ù‚Ø·Ø¹ Ø§Ù„Ø§Ø®ØªÙŠØ§Ø±",
            ...
            shrink: "Ø§Ù„Ø­Ø¬Ù… Ø§Ù„ØªÙ‚Ù„ÙŠØ¯ÙŠ",
            ...
            "Edit link": "ØªØ¹Ø¯ÙŠÙ„ Ø§Ù„Ø±Ø§Ø¨Ø·",
            "No follow": "Ø³Ù…Ø© Nofollow",
            Unlink: "Ø¥Ø²Ø§Ù„Ø© Ø§Ù„Ø±Ø§Ø¨Ø·",
            Update: "ØªØ­Ø¯ÙŠØ«",
            " URL": "URL",
            Edit: "ØªØ­Ø±ÙŠØ±",
            "Horizontal align": "Ù…Ø­Ø§Ø°Ø§Ø© Ø£ÙÙ‚ÙŠØ©",
            Filter: "ÙÙ„ØªØ±",
            "Sort by changed": "Ø¹Ù† Ø·Ø±ÙŠÙ‚ Ø§Ù„ØªØºÙŠÙŠØ±",
            ...
            Select: "ØªÙ…ÙŠØ²",
            "Select %s": "ØªÙ…ÙŠØ² %s",
            "Vertical align": "Ù…Ø­Ø§Ø°Ø§Ø© Ø¹Ù…ÙˆØ¯ÙŠØ©",
            ...
            "License: %s": "Ø±Ø®ØµØ© %s",
            Delete: "Ø­Ø°Ù",
            "Split vertical": "Ø§Ù†Ù‚Ø³Ø§Ù… Ø¹Ù…ÙˆØ¯ÙŠ",
            "Split horizontal": "ØªÙ‚Ø³ÙŠÙ… Ø£ÙÙ‚ÙŠ",
            Border: "Ø§Ù„Ø­Ø¯ÙˆØ¯",
            "Your code is similar to HTML. Keep as HTML?": "ÙŠØ´Ø¨Ù‡ Ø§Ù„ÙƒÙˆØ¯ Ø§Ù„Ø®Ø§Øµ Ø¨Ùƒ HTML. ØªØ¨Ù‚ÙŠ ÙƒÙ…Ø§ HTMLØŸ",
            "Paste as HTML": "Ø§Ù„ØµÙ‚ Ùƒ HTML",
            Keep: "Ø§Ø­ØªÙØ¸",
            "Insert as Text": "Ø¥Ø¯Ø±Ø§Ø¬ ÙƒÙ†Øµ",
            "Insert only Text": "Ø¥Ø¯Ø±Ø§Ø¬ Ø§Ù„Ù†Øµ ÙÙ‚Ø·",
            "You can only edit your own images. Download this image on the host?": "ÙŠÙ…ÙƒÙ†Ùƒ ÙÙ‚Ø· ØªØ­Ø±ÙŠØ± ØµÙˆØ±Ùƒ Ø§Ù„Ø®Ø§ØµØ©. ØªØ­Ù…ÙŠÙ„ Ù‡Ø°Ù‡ Ø§Ù„ØµÙˆØ±Ø© Ø¹Ù„Ù‰ Ø§Ù„Ù…Ø¶ÙŠÙØŸ",
            "The image has been successfully uploaded to the host!": "ØªÙ… ØªØ­Ù…ÙŠÙ„ Ø§Ù„ØµÙˆØ±Ø© Ø¨Ù†Ø¬Ø§Ø­ Ø¹Ù„Ù‰ Ø§Ù„Ø®Ø§Ø¯Ù…!"
        }
    }, function(e, t, o) {
        "use strict";
        Object.defineProperty(t, "__esModule", {
